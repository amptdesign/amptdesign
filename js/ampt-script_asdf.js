$(document).ready(function() {
  ...
  // ==================================================
    ...
    $( "#learn-1" ).click(function() {
            ...
            setTimeout(function(){
                          $(".our-services-2").stop(true, true).fadeIn({ duration: 2000, queue: false }).addClass('my-flip');
                          setTimeout(act2, 1400);
                      }, 900);

            var act2 = function () {
                          $(".web2").stop(true, true).fadeIn({ duration: 3000, queue: false }).addClass('my-flip');
                          $('.color-circle').tween({ 
                              opacity:{ start: 0, stop: 50, time: 2, duration: 10, effect:'easeInOut' }
                              // ,
                              // rotate: { start: 451, stop: 339,time: 2, duration: 10, effect:'easeInOut' }
                           });
                          $.play();
                          setTimeout(act3, 800);
            }
            ...
            var act4 = function () {
                $(".web3").stop(true, true).fadeIn({ duration: 4800, queue: false }).addClass('my-flip');
                 setTimeout(act5, 3000);
            }

            var act5 = function () {
                $(".web4").stop(true, true).fadeIn({ duration: 3000, queue: false }).addClass('my-flip');
            ...
            var act7 = function () {
                  ...
                  setTimeout(cleanHouse, 2000);
            }

            var act8 = function () { $(".color-circle").addClass('animated ampt-fadeIn'); }
            ...
            function cleanHouse() {
                  ...
                  // $(".hottie-rocket").css({"opacity":"0"});
                  // $(".web2",".web3",".web4","#win","#maybe-later").css({"display":"none"});
                  // act2,act3,act4,act5,act6,act7,act8 = null;
            }
